...
{  
    ...
    char c[10000];
    ret = recvfrom(sockfd, c, iph->tot_len, 0,   (struct sockaddr*)&(parg->daddr), &n);  
...
#define MAX_IP_SIZE 16   
    uint8_t sip[MAX_IP_SIZE] = "127.0.0.1";  
    uint8_t dip[MAX_IP_SIZE] = "127.0.0.1";  
    ...
    inet_pton(AF_INET, (char *)sip, (void*)&args.saddr.sin_addr);  
    args.saddr.sin_port = htons(sport);  
  
    inet_pton(AF_INET, (char * )dip, (void*)&args.daddr.sin_addr);  
